...
namespace Leaf.Datalayers.PaymentMethod
{
    public class DataLayer : Leaf.Data.DataLayerBaseMySQL
    {
        ...
        internal DataTable loadByCode(string code)
        {
            try
            {
                string sql = @"SELECT * FROM payment_method WHERE CODE = @CODE";
        ...
        internal int Create(Models.PaymentMethod center)
        {
        ...
        internal int Save(Models.PaymentMethod center)
        {
